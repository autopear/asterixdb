...
public class GoogleDefaultMergePolicyFactory implements ILSMMergePolicyFactory {
    ...
    public ILSMMergePolicy createMergePolicy(Map<String, String> configuration, INCServiceContext ctx) {
        ILSMMergePolicy policy = new GoogleDefaultMergePolicy();
    ...
    public static IJsonSerializable fromJson(IPersistedResourceRegistry registry, JsonNode json) {
        return new GoogleDefaultMergePolicyFactory();
    }
}
