...
import org.apache.hyracks.storage.am.lsm.common.impls.BalanceMergePolicyFactory;
...
public class PersistedResourceRegistry implements IPersistedResourceRegistry {
    ...
    protected void registerClasses() {
        ...
        REGISTERED_CLASSES.put("BalanceMergePolicyFactory", BalanceMergePolicyFactory.class);
        REGISTERED_CLASSES.put("BigtableMergePolicyFactory", BigtableMergePolicyFactory.class);
